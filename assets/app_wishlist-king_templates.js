const templates = [
              ...
              {% unless limit and item_count > limit %}
                ...
                <div>
                  <div class="wk-grid__item {% if onsale %}wk-product--sale{% endif %}" data-wk-item="{{ product.wishlist_item_id }}">
                    ...
                    <div class="wk-product-info text-center">
  ...
  },
  {
    id: "wishlist-icon",
    template: `
<svg class="wk-icon__svg" width="100%" height="100%" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 26 23.5" xml:space="preserve">
<path d="M6.9,0.6c-1.6,0-3.2,0.6-4.4,1.9c-2.4,2.6-2.4,6.7,0,9.3l10.3,10.9l0,0c0.1,0.1,0.1,0.1,0.2,0.1s0.2,0,0.2-0.1
  c3.4-3.6,6.8-7.3,10.3-10.9c2.4-2.6,2.4-6.7,0-9.3s-6.4-2.6-8.8,0L13,4.3l-1.7-1.8C10.1,1.3,8.5,0.6,6.9,0.6L6.9,0.6z"/>
</svg>
    `,
  },
  {
